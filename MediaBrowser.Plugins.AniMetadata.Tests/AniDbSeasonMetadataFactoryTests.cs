...
namespace MediaBrowser.Plugins.AniMetadata.Tests
{
    ...
    public class AniDbSeasonMetadataFactoryTests
    {
        ...
        public void CreateMetadata_AddAnimeGenreIsFalse_DoesNotAddAnimeGenre()
        {
            ...
            var metadataFactory = new AniDbSeasonMetadataFactory(_titleSelector, _pluginConfiguration);
        ...
        [Test]
        public void CreateMetadata_NoDescription_DoesNotThrow()
        {
            var series = new AniDbSeriesData().WithStandardData();
            ...
            Action action = () => metadataFactory.CreateMetadata(series, 1, "en");
