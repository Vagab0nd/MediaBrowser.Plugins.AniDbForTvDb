...
namespace MediaBrowser.Plugins.AniMetadata.Tests
{
    ...
    public class AniDbEpisodeMetadataFactoryTests
    {
        ...
        public void CreateMetadata_AbsoluteEpisodeNumber_HasTvDbEpisodeId_SetsTvDbProviderId(LibraryStructure libraryStructure)
        {
        ...
        [TestCase(LibraryStructure.AniDb)]
        [TestCase(LibraryStructure.TvDb)]
        public void CreateMetadata_AbsoluteEpisodeNumber_NoTvDbEpisodeId_DoesNotSetTvDbProviderId(LibraryStructure libraryStructure)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        public void CreateMetadata_AbsoluteEpisodeNumber_SetsAbsoluteEpisodeNumber(LibraryStructure libraryStructure, int expectedAbsoluteIndex, int? expectedIndex)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        [TestCase(LibraryStructure.AniDb)]
        [TestCase(LibraryStructure.TvDb)]
        public void CreateMetadata_CombinedData_AbsoluteEpisodeNumber_HasTvDbEpisodeId_SetsTvDbProviderId(LibraryStructure libraryStructure)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        [TestCase(LibraryStructure.AniDb)]
        [TestCase(LibraryStructure.TvDb)]
        public void CreateMetadata_CombinedData_AbsoluteEpisodeNumber_NoTvDbEpisodeId_DoesNotSetTvDbProviderId(LibraryStructure libraryStructure)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        [TestCase(LibraryStructure.AniDb, 64, 64)]
        [TestCase(LibraryStructure.TvDb, 22, null)]
        public void CreateMetadata_CombinedData_AbsoluteEpisodeNumber_SetsAbsoluteEpisodeNumber(LibraryStructure libraryStructure, int expectedAbsoluteIndex, int? expectedIndex)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        public void CreateMetadata_CombinedData_MappedEpisodeNumber_SetsIndexFields(LibraryStructure libraryStructure, int expectedIndex, int expectedSeasonIndex)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        [TestCase(LibraryStructure.AniDb, 64, 1)]
        [TestCase(LibraryStructure.TvDb, 44, 3)]
        public void CreateMetadata_CombinedData_MappedEpisodeNumberWithNoEpisodeId_DoesNotSetTvDbProviderId(LibraryStructure libraryStructure, int expectedIndex, int expectedSeasonIndex)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        [TestCase(LibraryStructure.AniDb)]
        [TestCase(LibraryStructure.TvDb)]
        public void CreateMetadata_CombinedData_UnmappedEpisodeNumber_UsesAniDbEpisodeNumber(LibraryStructure libraryStructure)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        [TestCase(LibraryStructure.AniDb)]
        [TestCase(LibraryStructure.TvDb)]
        public void CreateMetadata_MappedEpisodeNumber_HasFollowingEpisode_SetAirsBeforeFields(LibraryStructure libraryStructure)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        public void CreateMetadata_MappedEpisodeNumber_NoFollowingEpisode_DoesNotSetAirsBeforeFields(LibraryStructure libraryStructure)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        [TestCase(LibraryStructure.AniDb, 64, 1)]
        [TestCase(LibraryStructure.TvDb, 44, 3)]
        public void CreateMetadata_MappedEpisodeNumber_SetsIndexFields(LibraryStructure libraryStructure, int expectedIndex, int expectedSeasonIndex)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
        ...
        [TestCase(LibraryStructure.AniDb, 64, 1)]
        [TestCase(LibraryStructure.TvDb, 44, 3)]
        public void CreateMetadata_MappedEpisodeNumberWithNoEpisodeId_DoesNotSetTvDbProviderId(LibraryStructure libraryStructure, int expectedIndex, int expectedSeasonIndex)
        {
            _pluginConfiguration.LibraryStructure.Returns(libraryStructure);
