...
{
    public class TvDbEpisodeDetailData : TvDbEpisodeData
    {
        public TvDbEpisodeDetailData(int id, string episodeName, Option<long> absoluteNumber, int airedEpisodeNumber,
